...
export class LoginComponent implements OnInit {
  ...
  openForgotPasswordModal(dynamicContent: string = 'Example') {
    const config = new TemplateModalConfig < IContext,
  ...
  resetPassword() {
    ...
    this.authService.sendPasswordResetEmail(this.resetPasswordForm.value.email).then(
      ...
      () => {
        ...
        this.toastr.success('Check your email Inbox for link to reset your password !!!', 'Success');
        this.showSuccessMessage =  true;
        this._user_email = this.resetPasswordForm.value.email;
      },
      err => {
        console.log(err)
        this.errorMessage = '';
